...
function preload() {
  sunTexture = loadImage('./js/data/sol1.jpg');
  textures[0] = loadImage('./js/data/marte.jpg');
  textures[1] = loadImage('./js/data/tierra.jpg');
  textures[2] = loadImage('./js/data/mercurio.jpg');
}
